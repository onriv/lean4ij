// TODO removed for using internal api:
//      check it in detail when add back swing impl infoview
//      #Internal method com.intellij.codeInsight.documentation.DocumentationHtmlUtil.getDocPopupPreferredMinWidth() invocation
//      Internal method com.intellij.codeInsight.documentation.DocumentationHtmlUtil.getDocPopupPreferredMinWidth() : int is invoked in lean4ij.toolWindow.CodeWithInfosDocumentationHyperLink.getPreferredContentWidth(int) : int. This method is marked with @org.jetbrains.annotations.ApiStatus.Internal annotation or @com.intellij.openapi.util.IntellijInternalApi annotation and indicates that the method is not supposed to be used in client code.
